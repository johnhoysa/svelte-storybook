...
<section class="p-2">
	...
	<p>
		<a href="/style-guide/headline" class="text-blue-600 visited:text-purple-600">Headline</a>
	</p>
	<p>
...
<section class="p-2">
	...
	<p>
		<a href="/style-guide/modal" class="text-blue-600 visited:text-purple-600">Modal</a>
	</p>
	<p>
		<a href="/style-guide/form" class="text-blue-600 visited:text-purple-600">Form Testing</a>
	</p>
</section>
